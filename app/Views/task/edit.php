...
<div class="mb-3">
  <div>
    <label class="form-label float-start">Task File or Image:</label>
  </div>
  <button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#exampleModal">Edit File <i class="bi bi-pencil"></i></button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form method="post" action="/task/file/<?=$task['tid']?>" enctype="multipart/form-data">
              <div class="modal-body">
                <div class="mb-2">
                    <label class="form-label">File Or Image</label>
                </div>
                <div class="mb-2">
                  <input type="file" name="tpic" class="form-control">
                </div>
              </div>
            </div>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="/task/file/<?=$task['tid']?>" method='POST' enctype="multipart/form-data">
<div class="mb-3">
  <label for="formFile" class="form-label">Insert File</label>
  <input class="form-control" type="file" name="tpic" id="formFile">
</div>
</div>
<div class="modal-footer">
