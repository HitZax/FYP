    ...
    <div class="row">
      <div class="col-md-6 offset-md-3 pt-4 mt-5">  
        <div class="row mb-3">
          ...
          <h6 class="text-white">Create your student account to login to the system</h6>
        </div>
        <form action="/register" method="post">
          <div class="mb-3">
            <label class="form-label float-start text-white">Full Name</label>
              <input type="text" name="name" placeholder="Full name"  class="form-control" required>
              <div class="invalid-feedback">Please enter your Full Name.</div>
          </div>
          <div class="mb-3">
            <label class="form-label float-start text-white">Student ID</label>
          ...
          <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label float-star text-white">Email</label>
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Email" name="email" required>
              <div class="invalid-feedback">Please enter your Email.</div>
          </div>
          <div class="mb-3">
            <label for="program" class="form-label float-start text-white">Programme</label>
          ...
          <label for="exampleInputPassword1" class="form-label float-start text-white">Confirm Password</label>
        ...
        <div class="row mt-2 mb-4">
          <h6>Need an account for lecturer? <span><a href="/register/lecturer" @click="analyticEvent('Authentication', 'Click', 'Register button on login page')">Register</a></span></h6>
        </div>
